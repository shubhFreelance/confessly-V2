...
export const getBlockedUsers = async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Server error while getting blocked users' });
  }
};
...
export const createSuperAdmin = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Server error while creating super admin' });
  }
};
...
export const getConfessionLink = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Server error while getting confession link' });
  }
};
...
export const getMessageCount = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const messageCount = await Confession.countDocuments({ recipient: user._id });
...
export const getReportedConfessions = async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Server error while getting reported confessions' });
  }
};
...
export const getAdminStats = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const reportedConfessions = await Confession.countDocuments({ isReported: true });
...
export const getWeeklyRankings = async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Server error while getting weekly rankings' });
  }
};
...
export const getMonthlyRankings = async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Server error while getting monthly rankings' });
  }
};
...
export const getUserRankings = async (req: AuthRequest, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Server error while getting user rankings' });
  }
}; 